...
const nllbClipLanguages = new Map([
...
export const models: MultimodalMetadata[] = [
  ...
  },
  {
    ...
    modelPaths: new Map([
      [
        "image",
        "https://web-ai-models.org/multimodal/nllb-clip-large/image-quant.onnx.gz",
      ],
      [
        "text",
        "https://web-ai-models.org/multimodal/nllb-clip-large/text-quant.onnx.gz",
      ],
      [
        "combine",
        "https://web-ai-models.org/multimodal/nllb-clip-large/combine.onnx",
      ],
    ]),
    preprocessorPath:
      "https://web-ai-models.org/multimodal/nllb-clip-siglip/preprocessor_config.json",
