  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Web AI Next.js segmentation example"
        />
          ...
          <div className="row">
            <div className="col">
              ...
              <ol>
                ...
                <li>
                  Mark the object in the image. Mark with foreground points what
                  you want to detect, with background points - what you want to
                  exclude from the mask. You can also mark the target object
                  with a bounding box.
                </li>
                <li>
                  Click the &quot;Segment&quot; button. The first time, the
                  model will run for about 15-20 seconds.
                </li>
                <li>
                  Repeat the process. After the first run, the model will run
                  instantaneously.
                </li>
              </ol>
            </div>
